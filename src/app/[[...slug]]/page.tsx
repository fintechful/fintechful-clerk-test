...
export default function SubdomainPage() {
  // Extract subdomain from hostname (works on Vercel + localhost)
  const hostname = typeof window !== 'undefined' ? window.location.hostname : '';
  const subdomain = hostname.split('.')[0]; // jane, mike, test123, etc.

  const isMainDomain = ['fintechful-clerk-test', 'localhost', 'fintechful'].includes(subdomain);
        ...
        {isMainDomain ? (
          ...
          <>
            ...
            <p className="text-2xl mb-12">
              ...
              <code className="text-3xl bg-gray-100 px-4 py-2 rounded">{subdomain}.fintechful.com</code>
            </p>
            <a
              href="/dashboard"
